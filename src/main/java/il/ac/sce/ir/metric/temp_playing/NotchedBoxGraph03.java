...
public class NotchedBoxGraph03 extends JPanel {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            NotchedBoxGraph03 comp = new NotchedBoxGraph03();
            // comp.setA("Temp Test");
            comp.setGraphName("Some samples test!");
            comp.setMultiNotchedBoxData(genData());
            comp.setBorderPx(40);
            frame.add(comp);
            frame.pack();
    ...
    static MultiNotchedBoxData genData() {
        /*double[] data01 =
                {1, 58,  63,  69,  72,  74,  79,
                        88,  88,  90,  91,  93,  94,
                        97,  97,  99,  99,  99,  100,
...
*/
        ...
        double[] data03 =
                {25, 58,  63,  69,  72,  74,  79,
                        88,  88,  90,  91,  93,  94,
                        97,  97,  99,  99,  99,  100,
                        103, 104, 105, 107, 118, 127};

        MultiNotchedBoxData multiNotchedBoxData = new MultiNotchedBoxData(false);
        /*multiNotchedBoxData.add("Winter", data01);*/
